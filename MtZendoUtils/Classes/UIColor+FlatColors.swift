...
//  PaperBoat
//
//  Created by Chen Yue on 12/05/19.
//  Copyright © 2019 Chen Yue. All rights reserved.
//
...
extension UIColor {
    struct FlatColor {
        struct Custom {
            static let RedDoor = UIColor(red: 168, green: 69, blue: 58)
            static let WhiteWall = UIColor(red: 227, green: 226, blue: 224)
            static let BlackWindowFrame = UIColor(red: 37, green: 36, blue: 38)
            static let BlueShort = UIColor(red: 37, green: 42, blue: 60)
        }
        struct Green {
